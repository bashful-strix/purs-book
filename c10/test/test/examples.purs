module Test.Cp10.Examples where
...
foreign import showEqualityImpl
  :: forall a. (a -> a -> Boolean) -> (a -> String) -> a -> a -> String
...
foreign import diagonalAsyncImpl
  :: Int -> Number -> Number -> Effect (Promise Number)
